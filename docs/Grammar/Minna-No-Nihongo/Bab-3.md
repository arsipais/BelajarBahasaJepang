Tentu, ini dia teksnya yang sudah dirapikan ke dalam format Markdown yang terstruktur dan mudah dibaca.
...
1.  (Kamu lagi di kelas) `私の席は ここです。` (Watashi no seki wa koko desu.) → "Kursi saya di sini."
